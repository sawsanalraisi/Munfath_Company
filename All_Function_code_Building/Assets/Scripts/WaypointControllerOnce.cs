...
public class WaypointControllerOnce : MonoBehaviour
{
   ...
   // public bool IsMoveRobot = false;

    //Robot
    public GameObject Robot;//once
    public bool OnceTimeMove = true;
    ...
    void Start()
    {
     ...
     void Update()
    {
        if (DataManger.Instance.IsAllowToMoveRobot == true)
        {
            MoveRobotFun();
        }
    }
